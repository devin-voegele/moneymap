...
-- CreateEnum
CREATE TYPE "SubscriptionWorthIt" AS ENUM ('YES', 'MAYBE', 'NO');
...
CREATE TABLE "users" (
    ...
    "monthlyAiRequests" INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE "subscriptions" (
    ...
    "worthIt" "SubscriptionWorthIt" DEFAULT 'YES',
    "aiSuggestion" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- AddForeignKey
ALTER TABLE "fixed_costs" ADD CONSTRAINT "fixed_costs_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
